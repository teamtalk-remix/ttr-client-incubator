...
func (*IMHeartBeat) Descriptor() ([]byte, []int) {
	return fileDescriptor_IM_Other_4224ffa23c5ef27b, []int{0}
}
...
func init() { proto.RegisterFile("IM.Other.proto", fileDescriptor_IM_Other_4224ffa23c5ef27b) }

var fileDescriptor_IM_Other_4224ffa23c5ef27b = []byte{
